...
object Deps {
  ...
  val SPARK_VERSION = "3.1.2"  // for local
  // val SPARK_VERSION = "2.4.8"  // for EMR
}

object report extends ScalaModule { outer =>

  import Deps._ 
  // ************* SET SCALA VERSION HERE *****************
  def scalaVersion = "2.12.15"  // for local
  // def scalaVersion = "2.11.12"   // for EMR
